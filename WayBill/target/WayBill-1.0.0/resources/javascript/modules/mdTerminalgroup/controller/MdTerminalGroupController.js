Ext.define('MdTerminalGroupModule.controller.MdTerminalGroupController', {
	    ...
	    this.control({'textfield[name=searchField]': {
	    	...
	    	'button[action=addItem]':{
	    		click: function(){
	            	...
	            	if(!win){win = Ext.create('MdTerminalGroupModule.view.PrintsetWindow');}
	    	...
	    	'button[action=add]':{
	    		click: function(){
	            	...
	            	// 判断窗体对象是否存在, 如果不存在，就创建一个新的窗体对象
	            	if(!win){win = Ext.create('MdTerminalGroupModule.view.MdTerminalGroupWindow');}
	        	...
	        	click: function(){
	                ...
	                if (formObj.isValid()) {
	                    formObj.submit({
	                        ...
	                        waitTitle: '提示', // 标题  
	                        url: 'services/mdGroupModify', // 请求的url地址  
	                        method: 'POST', // 请求方式  
